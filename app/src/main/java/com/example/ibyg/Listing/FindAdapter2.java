...
public class FindAdapter2 extends LinearLayout {
    ...
    public void setPostInfo(OwnerInfo ownerInfo){
        ...
        Glide.with(context).load(ownerInfo.getPhotoUrl()).into(image);
...
//
//        TextView text19 = findViewById(R.id.Text19);    //메뉴이름
//        text19.setText("가격");
